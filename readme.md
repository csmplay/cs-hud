...
1. Download [`cs-hud-server-win.exe`](https://github.com/csmplay/cs-hud/releases/latest/download/cs-hud-server-win.exe) if you're on Windows, or [`cs-hud-server-linux`](https://github.com/csmplay/cs-hud/releases/latest/download/cs-hud-server-linux) if you're on Linux. You can find more details on the [Releases tab](https://github.com/csmplay/cs-hud/releases/latest).
...
1. Make sure you've followed the instructions above. You should see a console window saying `cs-hud is active`.
1. Download [`cs-hud-overlay-win32-x64.zip`](https://github.com/csmplay/cs-hud/releases/latest/download/cs-hud-overlay-win32-x64.zip) on Windows, or [`cs-hud-overlay-linux-x64.tar.gz`](https://github.com/csmplay/cs-hud/releases/latest/download/cs-hud-overlay-linux-x64.tar.gz) on Linux. Extract all files.
